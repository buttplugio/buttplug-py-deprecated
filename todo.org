...
*** TODO Add a way to know if we're trying to close something that doesn't have a heartbeat
...
*** TODO Make test plugin hold temp files to act like device claims
