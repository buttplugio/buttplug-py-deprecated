...
*** TODO Spin msg loop for a bit on exit to make sure everything closes
*** TODO Make sure plugin processes close on exit, warn otherwise
*** TODO Convert device claim function into full device plugin process lifetime
*** TODO Convert client function into full client connection lifetime
*** TODO Add ability to use json or msgpack
*** TODO Add identity to greenlet names if it's a parameter to the function
*** TODO Make sure client disconnect means claims are released
